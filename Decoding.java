...
public class Decoding {
  ...
  public static void main(String[] args) throws IOException{
    ...
    try {
      in = new FileInputStream("EXAMPLE.MZIP"); //Create reader for file
      ...
      /**************************************BUILD AND USE TREE**********************************************/
      String test = "(65 ((66 67) (68 69)))";
      
      Decoder decoder = new Decoder(test); //Create a decoder
      ...
      decoder.setChain(decoder.switchString(test));
